...
$_LANG['clientareaerroremailexists'] = "输入的电子邮件地址不可用。";
$_LANG['clientareaerrorusernotassoc'] = "输入的电子邮件地址不可用。";
...
$_LANG['networkIssuesAware'] = "我们发现可能影响服务的问题。";
$_LANG['networkIssuesScheduled'] = "即将发生的维护事件可能会影响我们的服务。";
...
$_LANG['store']['sitelock']['featuresLink'] = "特点";
$_LANG['store']['sitelock']['websiteHacked'] = "网站被黑客攻击？";
$_LANG['store']['sitelock']['faq'] = "FAQ";
$_LANG['store']['sitelock']['contentHeadline'] = "针对您的网站的网站安全和恶意软件防护";
$_LANG['store']['sitelock']['contentBodyParagraph1'] = "是网站安全领域的全球领先者，保护您的网站，让您高枕无忧。";
$_LANG['store']['sitelock']['contentBodyParagraph2'] = "SiteLock的每日恶意软件扫描可识别漏洞和已知恶意代码，并自动将其从您的网站中删除，以保护您的网站和访问者免受威胁。";
$_LANG['store']['sitelock']['contentBodyParagraph3'] = "此外，您还可以获得SiteLock Trust Seal，它可以建立客户信心，并被证明可以提高销售额和转换率。";
$_LANG['store']['sitelock']['comparePlans'] = "比较SiteLock";
$_LANG['store']['sitelock']['comparePlansSubtitle'] = "您网站的专业安全功能";
$_LANG['store']['sitelock']['featuresTitle'] = "SiteLock的特点";
$_LANG['store']['sitelock']['featuresHeadline'] = "提供一系列旨在保护您的网站和企业声誉的功能：";
$_LANG['store']['sitelock']['featuresMalwareTitle'] = "恶意软件扫描";
$_LANG['store']['sitelock']['featuresMalwareContent'] = "主动监视您的网站上检测到的任何恶意软件并向您发出警报。";
$_LANG['store']['sitelock']['featuresMalwareRemovalTitle'] = "自动删除恶意软件";
$_LANG['store']['sitelock']['featuresMalwareRemovalContent'] = "如果扫描发现任何内容，SiteLock将自动安全地删除任何已知的恶意软件。";
$_LANG['store']['sitelock']['featuresVulnerabilityTitle'] = "漏洞扫描";
$_LANG['store']['sitelock']['featuresVulnerabilityContent'] = "自动检查您的应用程序，以确保它们是最新的，并针对已知漏洞进行保护。";
$_LANG['store']['sitelock']['featuresOWASPTitle'] = "OWASP 保护";
$_LANG['store']['sitelock']['featuresOWASPContent'] = "针对开放网络应用安全项目(OWASP)确认的十大网络应用安全漏洞提供保护。";
$_LANG['store']['sitelock']['featuresTrustSealTitle'] = "SiteLock&trade; Trust Seal";
$_LANG['store']['sitelock']['featuresTrustSealContent'] = "向访问者展示您的网站受SiteLock保护，从而增加访问者的信心。";
$_LANG['store']['sitelock']['featuresFirewallTitle'] = "防火墙";
$_LANG['store']['sitelock']['featuresFirewallContent'] = "TrueShield&trade; Web应用程序防火墙可保护您的网站免受黑客和攻击。";
$_LANG['store']['sitelock']['featuresReputationTitle'] = "保护您的声誉";
$_LANG['store']['sitelock']['featuresReputationContent'] = "每日扫描有助于在搜索引擎有机会找到恶意软件并将您的站点列入黑名单之前及早发现恶意软件。";
$_LANG['store']['sitelock']['featuresSetupTitle'] = "快速自动设置";
$_LANG['store']['sitelock']['featuresSetupContent'] = "即时和全自动安装可立即为您提供保护，而无需安装任何内容。";
$_LANG['store']['sitelock']['featuresCDNTitle'] = "内容分发网络 (CDN)";
$_LANG['store']['sitelock']['featuresCDNContent'] = "通过在全球范围内分发网站，并从最近的位置为访问者提供服务，从而加快网站的速度，无论他们身在何处，都能获得更快的页面加载速度。";
$_LANG['store']['sitelock']['emergencyPlanTitle'] = "网站被黑？";
$_LANG['store']['sitelock']['emergencyPlanHeadline'] = "立即使用SiteLock应急响应进行修复";
$_LANG['store']['sitelock']['emergencyPlanBody'] = "如果您的网站遭到攻击和破坏，请立即获得紧急援助以快速恢复您的网站。以下是SiteLock紧急响应提供的帮助：";
$_LANG['store']['sitelock']['emergencyPlanResponseTitle'] = "立即响应";
$_LANG['store']['sitelock']['emergencyPlanResponseContent'] = "通过30分钟内开始的分析和恢复工作，获得我们最快的响应时间。";
$_LANG['store']['sitelock']['emergencyPlanMalwareTitle'] = "完全删除恶意软件";
$_LANG['store']['sitelock']['emergencyPlanMalwareContent'] = "如果我们的自动技术无法删除恶意内容，我们将执行手动清理。";
$_LANG['store']['sitelock']['emergencyPlanPriorityTitle'] = "优先处理";
$_LANG['store']['sitelock']['emergencyPlanPriorityContent'] = "有了应急包，您可以快速跟踪到队列顶部。";
...
$_LANG['store']['sitelock']['faqTitle'] = "常见问题解答";
$_LANG['store']['sitelock']['faqOneTitle'] = "什么是SiteLock？";
$_LANG['store']['sitelock']['faqOneBody'] = "SiteLock为各种规模的网站提供简单、快速和实惠的网站安全保护。该公司成立于2008年，为全球1200多万个网站提供保护。基于SiteLock云的产品套件提供自动网站漏洞检测和恶意软件删除、DDoS保护、网站加速、网站风险评估和PCI合规性。";
$_LANG['store']['sitelock']['faqOneBodyLearnMore'] = "要了解有关SiteLock的更多信息，请访问 :learnMoreLink";
$_LANG['store']['sitelock']['faqOneBodyLearnLinkText'] = "单击此处观看《SiteLock如何工作》视频";
$_LANG['store']['sitelock']['faqTwoTitle'] = "SiteLock能做什么？";
$_LANG['store']['sitelock']['faqTwoBody'] = "SiteLock提供全面的网站安全。它每天执行网站扫描以识别漏洞或恶意软件。当发现漏洞或恶意软件时，会立即通知您。根据您的SiteLock扫描程序，它将自动删除您网站上的所有恶意软件。对于内容管理系统(CMS)网站，SiteLock可以自动修补发现的漏洞。";
$_LANG['store']['sitelock']['faqThreeTitle'] = "SiteLock会扫描哪些类型的问题？";
$_LANG['store']['sitelock']['faqThreeBody'] = "SiteLock拥有执行全面网站扫描的技术，包括：";
$_LANG['store']['sitelock']['faqThreeBodyList1Title'] = "基于文件的恶意软件扫描和删除";
$_LANG['store']['sitelock']['faqThreeBodyList1'] = "SiteLock每天对网站的文件执行恶意软件扫描。如果发现恶意软件，会立即通知网站所有者。SiteLock还提供全面的扫描功能，以自动删除恶意软件。";
$_LANG['store']['sitelock']['faqThreeBodyList2Title'] = "漏洞扫描";
$_LANG['store']['sitelock']['faqThreeBodyList2'] = "SiteLock对网站应用程序执行扫描，查找可能导致危害的常见漏洞。";
$_LANG['store']['sitelock']['faqThreeBodyList3Title'] = "应用安全和漏洞修补";
$_LANG['store']['sitelock']['faqThreeBodyList3'] = "SiteLock具有自动修补内容管理系统(CM)漏洞的技术。";
$_LANG['store']['sitelock']['faqFourTitle'] = "什么是漏洞和恶意软件？";
$_LANG['store']['sitelock']['faqFourBodyParagraph1'] = ":vulnerabilityStrong 是网站或Web应用程序代码中的弱点或配置错误，它使攻击者能够获得对该网站（可能是托管服务器）的某种程度的控制。大多数漏洞是通过自动方式利用的，例如漏洞扫描程序和僵尸网络。";
$_LANG['store']['sitelock']['websiteVulnerability'] = "网站漏洞";
$_LANG['store']['sitelock']['faqFourBodyParagraph2'] = ":malwareStrong 是恶意软件的缩写，用于收集敏感数据，未经授权访问网站甚至劫持计算机。";
$_LANG['store']['sitelock']['malware'] = "恶意软件";
$_LANG['store']['sitelock']['faqFiveTitle'] = "SiteLock会影响网站性能吗？";
$_LANG['store']['sitelock']['faqFiveBody'] = "不会。在网站扫描期间，SiteLock会将相关文件下载到安全的服务器并在那里执行扫描。这不会影响网站的内容、代码、带宽或网站上的服务器资源。";
$_LANG['store']['sitelock']['faqSixTitle'] = "什么是SiteLock Trust Seal？";
$_LANG['store']['sitelock']['faqSixBody'] = "SiteLock Trust Seal是一个广泛认可的安全徽章，可以在您的网站上显示。它清楚地表明您的网站是安全的，没有恶意软件。要向您的网站添加印章，只需在您网站的页脚区域包含SiteLock提供的代码片段。";
...
$_LANG['contactDetails'] = "联系方式";
$_LANG['createNewSupportRequest'] = "创建新的支持请求";

$_LANG['nonotifications'] = "无通知";
$_LANG['apply'] = "应用";
$_LANG['admin']['returnToAdmin'] = "返回管理区";
$_LANG['searchOurKnowledgebase'] = "搜索我们的帮助文档";
$_LANG['browseProducts'] = "浏览产品";
$_LANG['secureYourDomain'] = "今天注册并保护您的域名";
$_LANG['secureYourDomainShort'] = "保护您的域名";
$_LANG['transferYourDomain'] = "转移您的域名";
$_LANG['transferExtend'] = "立即转移，并将域名续费1年";
$_LANG['howCanWeHelp'] = "我们今天能帮上什么忙";
$_LANG['homepage']['submitTicket'] = "提交工单";
$_LANG['homepage']['manageServices'] = "管理服务";
$_LANG['homepage']['manageDomains'] = "管理域名";
$_LANG['homepage']['supportRequests'] = "请求支持";
$_LANG['homepage']['makeAPayment'] = "付款";
$_LANG['homepage']['yourAccount'] = "您的帐户";

$_LANG['downloads']['numDownload'] = ":num 个文件";
$_LANG['downloads']['numDownloads'] = ":num 个文件";
$_LANG['knowledgebase']['numArticle'] = ":num 个文章";
$_LANG['knowledgebase']['numArticles'] = ":num 个文章";

$_LANG['userLogin']['createAccount'] = "创建账户";
$_LANG['userLogin']['signInToContinue'] = "登录到您的帐户以继续";
$_LANG['userLogin']['notRegistered'] = "还没注册？";

$_LANG['networkIssues']['scheduled'] = "有 :count 个计划的网络存在问题。";
$_LANG['networkIssues']['http'] = "HTTP";
$_LANG['networkIssues']['ftp'] = "FTP";
$_LANG['networkIssues']['pop3'] = "POP3";
$_LANG['networkIssues']['affectingYou'] = "此问题影响的服务器可能会影响您的服务";

$_LANG['chooseFile'] = "选择文件";
$_LANG['support']['postedBy'] = "在 :date 由 :name 发布 类型：:requestorType";
